...
Here's a vid of me making a laser driver for my LED based gas sensor. The voltage from a charged LED is dropped by impending light. Incoming light is impeded by absorption from gases at this wavelength. The time for the voltage drop corresponds to the absorption of gas between LEDs, thus giving us the concentration of gas.
